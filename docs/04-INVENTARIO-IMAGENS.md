...
O Hermes está ativado somente pelo profile explícito `mentor-concursos-hermes`; a
referência de runtime é o RepoDigest abaixo.

Verificação realizada em 2026-09-08 para `linux/amd64` com:

```bash
docker buildx imagetools inspect <imagem:versão>
docker image inspect ghcr.io/hostinger/hvps-hermes-agent@sha256:7af25fad2af3673f5be39824e38772a9895cb70af83c157917b4cd5e3983e9f9 \
...
| Hermes Agent | v0.20.4 observada; referência imutável aprovada | `sha256:7af25fad2af3673f5be39824e38772a9895cb70af83c157917b4cd5e3983e9f9` |
