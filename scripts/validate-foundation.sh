...
required=(
  ...
  database/seeds/003_receita_federal_topics.sql
  ...
  apps/external/connectors/search.py
  ...
  tests/unit/test_jurisprudence.py tests/unit/test_search.py
)
